/**
 * QR Code Generator - Full Auto-Sizing & UTF-8 Support
 */
var QRCode;
(function () {
    // UTF-8 Byte Encoder
    ...
    // Public QRCode Constructor
    QRCode = function (el, options) {
        this._htOption = {
            width: 256,
            height: 256,
            typeNumber: 0, // 0 = Auto detect size!
            colorDark: "#000000",
            colorLight: "#ffffff",
        ...
        if (typeof options === 'string') {
            ...
            for (var i in options) this._htOption[i] = options[i];
        }
    ...
    QRCode.prototype.makeCode = function (text) {
        this._oQRCode = new QRCodeModel(0, this._htOption.correctLevel || QRErrorCorrectLevel.M);
        ...
        // Check if browser document exists
        if (typeof document !== 'undefined') {
            // Render via SVG or Canvas
            var count = this._oQRCode.getModuleCount();
            var size = this._htOption.width || 256;
            var tile = size / count;

            // Use SVG for crisp rendering on any screen/print
            ...
            bg.setAttribute("fill", this._htOption.colorLight);
            svg.appendChild(bg);
            ...
            for (var row = 0; row < count; row++) {
                for (var col = 0; col < count; col++) {
                    if (this._oQRCode.isDark(row, col)) {
                        ...
                        rect.setAttribute("fill", this._htOption.colorDark);
