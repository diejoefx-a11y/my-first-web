...
// 1. Fetch All Groups for Filter 1
    ...
    <nav class="top-navbar">
        <div class="container-wide top-navbar-inner">
            ...
            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                ...
                <a href="pasangtitik.php" style="background: linear-gradient(135deg, #10b981, #059669); color: #fff; padding: 7px 14px; border-radius: 10px; font-weight: 700; font-size: 0.85rem; text-decoration: none; box-shadow: 0 2px 10px rgba(16,185,129,0.3);">
                    <i class="fa-solid fa-plus-circle"></i> Pasang Titik Baru
                </a>
                <a href="edit_data.php" style="background: rgba(139,92,246,0.25); border: 1px solid rgba(167,139,250,0.4); color: #e9d5ff; padding: 7px 14px; border-radius: 10px; font-weight: 700; font-size: 0.85rem; text-decoration: none;">
            ...
            <div class="filter-grid">
                ...
                <div>
                    ...
                    <select id="filterKelompok" class="filter-select" onchange="executeSearch()">
                        <option value="">-- Pilih Kelompok Pelayanan (1 s/d 14) --</option>
    ...
    <script>
        ...
        function executeSearch() {
            ...
            cards.forEach(card => {
                ...
                const matchSearch = (!searchQuery || namaKepala.includes(searchQuery) || noWA.includes(searchQuery) || alamat.includes(searchQuery));
